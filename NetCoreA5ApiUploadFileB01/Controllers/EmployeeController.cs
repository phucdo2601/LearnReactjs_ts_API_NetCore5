...
namespace NetCoreA5ApiUploadFileB01.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<EmployeeModel>>> GetEmployee()
        {
            return await _context.Employee
                .Select(x => new EmployeeModel()
                {
                    ...
                    ImageSrc = String.Format("{0}://{1}{2}/Files/{3}", Request.Scheme, Request.Host, Request.PathBase, x.ImageName)
                })
        ...
        public async Task<string> SaveImage(IFormFile imageFile)
        {
            ...
            var imagePath = Path.Combine(_hostEnvironment.ContentRootPath, "Files", imageName);
